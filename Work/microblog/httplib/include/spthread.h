...
#define __SPTHREAD_H__
	...
	*/
	...
	typedef sem_t           sp_thread_sem_t;

	#ifdef _IOS_

		int sp_thread_sem_init( sp_thread_sem_t * sem );

		#define sp_thread_sem_destroy(s)    sem_close(s)
		#define sp_thread_sem_wait(s)       sem_wait(s)
		#define sp_thread_sem_post(s)       sem_post(s)
		#define sp_thread_sem_unlink(name)  sem_unlink(name)

	#else

		#define sp_thread_sem_init(s)       sem_init(s,0,0)
		#define sp_thread_sem_destroy(s)    sem_destroy(s)
		#define sp_thread_sem_wait(s)       sem_wait(s)
		#define sp_thread_sem_post(s)       sem_post(s)
		#define sp_thread_sem_unlink(name)  (0)
	...
	#define sp_millisleep(x) usleep(1000*x)

#endif


#endif // __SPTHREAD_H__
