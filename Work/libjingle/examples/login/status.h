...
public:
  Status() :
    ...
    audio_capability_(false),
    video_capability_(false),
    call_capability_(false),
    from_status_chatroom_(false),
    ignore_abilities_(false),
    delay_(false) {};
  ...
  bool audio_capability() const { return audio_capability_; }
  bool video_capability() const { return video_capability_; }
  bool call_capability() const { return call_capability_; }
  bool from_status_chatroom() const { return from_status_chatroom_; }
  bool ignore_capability() const { return ignore_abilities_; }
  ...
  void set_audio_capability(bool f) { audio_capability_ = f; }
  void set_video_capability(bool f) { video_capability_ = f; }
  void set_call_capability(bool f) { call_capability_ = f; }
  void set_from_status_chatroom(bool f) { from_status_chatroom_ = f; }
  void set_ignore_capability(bool f) { ignore_abilities_ = f; }
  ...
  void set_delay(bool f) { delay_ = f; }
...
private:
  ...
  bool ignore_abilities_;
  bool audio_capability_;
  bool video_capability_;
  bool call_capability_;
  bool from_status_chatroom_;
  std::string version_;
  bool delay_;
